...
function nestedSliders() {
    ...
    sliders.forEach((slider,index) => {
        ...
        SlidersArray[index] = new Swiper(`._nested-slider[data-slider-id="${index}"] .swiper-container`, {
            ...
            on: {
                init: function () {
                    $(slider).find(".product-card__pagination").html("")
                    ...
                    let parentCard = $(slider).parents(".product-card")
...
$(".info-card__show").click(function() {
    if($(this).parents(".info-card").hasClass("_open")){
        $(".info-card").removeClass("_open")
        $(".info-card__hidden").slideUp()
    } else{
        $(".info-card").removeClass("_open")
        $(".info-card__hidden").slideUp()
        $(this).parents(".info-card").addClass("_open")
        $(this).parents(".info-card").find(".info-card__hidden").slideDown()
        nestedSliders()
    }
})
